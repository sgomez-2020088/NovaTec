        ...
        if(menu.equals("Principal")){
            ...
            switch(accion){
                ...
                case "Agregar":
                    ...
                    String codigoTipoProducto = request.getParameter("txtCodigoTipoProducto");
                    ...
                    producto.setCodigoProveedor(Integer.parseInt(codigoProveedor));
                ...
                case "Actualizar":
                    ...
                    String precioUnitarioA = request.getParameter("txtPrecioUnitario");
                    String existenciaA = request.getParameter("txtExistencia");
                    
                    Part imagenA = request.getPart("imagenProducto");
                    InputStream inputStreamA = imagenA.getInputStream();
                    
                    producto.setDescripcionProducto(descripcionProductoA);
                    producto.setPrecioUnitario(Double.parseDouble(precioUnitarioA));
                    producto.setExistencia(Integer.parseInt(existenciaA));
                    producto.setCodigoProducto(codProducto);
                    
                    if(imagenA !=null && imagenA.getSize()>0){
                        producto.setImagenProducto(inputStreamA);
                    }else{

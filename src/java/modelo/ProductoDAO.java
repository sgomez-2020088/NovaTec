...
public class ProductoDAO {
    ...
    public List listar(){
        ...
        try {
            ...
            while(rs.next()){
                ...
                pro.setCodigoProducto(rs.getString(1));
                pro.setDescripcionProducto(rs.getString(2));
                pro.setPrecioUnitario(rs.getDouble(3));
                pro.setImagenProducto(rs.getBinaryStream(4));
                pro.setExistencia(rs.getInt(5));
                pro.setCodigoTipoProducto(rs.getInt(6));
    ...
    //LISTAR IMAGEN
    public void listarImagen(int idp, HttpServletResponse response){
        String sql = "Select imagenProducto from Productos where codigoProducto="+idp;

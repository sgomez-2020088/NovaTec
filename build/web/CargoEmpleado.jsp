                ...
                <div class="card-body">
                    ...
                    <form action="Controlador?menu=CargoEmpleado" method="POST">
                        <div class="form-group">
                            <label><strong>Nombre Cargo:</strong></label>
                            <input type="text" value="" name="txtNombreCargo" class="form-control">
                        </div>
                        <div class="form-group">
                            <label><strong>Descripcion:</strong></label>
                            <input type="text" value="" name="txtDescripcionCargo" class="form-control">
                        </div>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-warning" href="Controlador?menu=CargoEmpleado&accion=Editar&codigoCargoEmpleado=">Editar</a>
                                <a class="btn btn-danger" href="Controlador?menu=CargoEmpleado&accion=Eliminar&codigoCargoEmpleado=">Eliminar</a>
                            </td>
                        </tr>
                        </c:forEach>
                    </tbody>
